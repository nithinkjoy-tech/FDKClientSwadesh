...
Pod::Spec.new do |s|
  s.name             = 'FDKClientSwadesh'
  s.version          = '1.0.0'
  s.summary          = 'FDK Client SDK for Swift language for Swadesh Project'

  s.description      = 'FDK Client SDK for Swift language that can be used to make Apps or extensions.'

  s.homepage         = 'https://github.com/nithinkjoy-tech/FDKClientSwadesh'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Shopsense Retail Technologies Limited' => 'shopsense@icloud.com', 'Nithin K Joy' => 'nithinkjoy.dev' }
  s.source           = { :git => 'https://github.com/nithinkjoy-tech/FDKClientSwadesh.git', :tag => s.version.to_s }
